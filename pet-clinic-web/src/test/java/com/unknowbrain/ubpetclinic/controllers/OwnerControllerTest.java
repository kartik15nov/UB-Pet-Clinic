...
class OwnerControllerTest {
    ...
    void findOwnersForm() throws Exception {
        ...
        //Make sure the controller doesn't interact with service.
    ...
    @Test
    void onButtonClickNewOpenCreationForm() throws Exception {
    ...
    @Test
    void onButtonClickNewSaveCreationForm() throws Exception {
    ...
    @Test
    void onButtonClickUpdateCreationForm() throws Exception {
        when(ownerService.findById(anyLong())).thenReturn(Owner.builder().id(1L).build());
    ...
    @Test
    void onButtonClickSaveUpdateCreationForm() throws Exception {
        when(ownerService.save(any())).thenReturn(Owner.builder().id(1L).build());
